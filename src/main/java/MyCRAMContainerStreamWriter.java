 ...
 */
public class MyCRAMContainerStreamWriter {
    ...
    private static final Log log = Log.getInstance(MyCRAMContainerStreamWriter.class);
    ...
    /**
     * Create a MyCRAMContainerStreamWriter for writing SAM records into a series of CRAM
     ...
     */
    public MyCRAMContainerStreamWriter(
